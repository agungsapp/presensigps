          ...
          <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle {{ request()->is(['karyawan','departmen']) ? 'show' : '' }}" href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" aria-expanded="{{ request()->is(['karyawan','departmen']) ? 'true' : '' }}" >
                ...
                <div class="dropdown-menu {{ request()->is(['karyawan','departmen']) ? 'show' : '' }}">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                    <a class="dropdown-item {{ request()->is(['departmen']) ? 'active' : '' }}" href="/departmen">
                        Departemen
                      </a>  
...
<li class="nav-item dropdown">
    ...
    <div class="dropdown-menu {{ request()->is('konfigurasi','konfigurasi/*') ? 'show' : '' }}">
        <div class="dropdown-menu-columns">
            <div class="dropdown-menu-column">
                <a class="dropdown-item {{ request()->is('konfigurasi','konfigurasi/lokasikantor') ? 'active' : '' }}" href="/konfigurasi/lokasikantor">
                    Lokasi Kantor
                </a>
            </div>
        </div>
