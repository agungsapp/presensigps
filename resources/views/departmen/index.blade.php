                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="col-2">
                                    <a href="#" class="btn btn-primary" id="btnTambahDepartmen">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <form action="/departmen" method="GET">
                                    <div class="row">
                                        <div class="col-10">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <div class="btn-group">
                                                <a href="#" class="edit btn btn-info" kode_dept="{{ $d->kode_dept }}">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <form action="/departmen/{{$d->kode_dept}}/delete" style="margin-left:5px" method="POST">
                                                    @csrf
...
<div class="modal modal-blur fade" id="modal-inputdepartmen" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('store')}}" method="POST" id="frmDepartmen">
                @csrf    
                <div class="row">
                        <div class="col-12">
                    ...
                    <div class="col-12">
                        <div class="input-icon mb-3">
                            ...
                            <input type="text" value="" id="nama_dept" class="form-control" name="nama_dept"
...
<div class="modal modal-blur fade" id="modal-editdepartmen" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
...
<script>
    $(function(){
        $("#btnTambahDepartmen").click(function(){
            $("#modal-inputdepartmen").modal("show");
        });
        ...
        $(".edit").click(function(){
            ...
            $("#modal-editdepartmen").modal("show");
        });
